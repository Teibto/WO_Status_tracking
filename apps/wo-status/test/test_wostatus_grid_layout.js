 ...
 *
 * ปัญหาที่กัน:
 *   1. **หัวตารางกับแถวต้องมีจำนวนช่องเท่ากัน** — `cpStatus` มี 11 ช่อง (11 checkpoint)
 *      ถ้าหัว/แถวไม่ตรงกัน (เช่น เผลอเพิ่ม/ลดคอลัมน์) หัวจะเลื่อนทั้งแถวและช่องท้ายไม่มีหัว
 *      และกันคอลัมน์ที่ 11 ("ตั้งค่าต้นทุนมาตรฐาน") หายจากหัว
