...
const dd = H.load({ libs: ['WOReportTheme.js', 'WOCostTrace_Common.js', 'WOCostTrace_Ready.js'], fixtures: ddFx, quietLog: true, exports: ['buildModel'] });
dd.T.buildModel(FX.WO_HEADER.wo_no);
const sum = H.load({ libs: ['WOReportTheme.js', 'WOCostTrace_Common.js', 'WOCostTrace_Ready.js'], fixtures: smFx, quietLog: true, exports: ['buildSummary', 'readFilters'] });
